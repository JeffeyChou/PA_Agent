...
class AnalysisRecord(BaseModel):
    ...
    analysis_contract: Optional[dict] = None
    harness_trace: list[dict] = Field(default_factory=list)
    pre_delivery_gate: Optional[dict] = None
    effective_decision: Optional[dict] = None
